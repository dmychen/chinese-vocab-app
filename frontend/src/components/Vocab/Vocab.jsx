 ...
 * @param {int} defaultSetId - The set that this vocab will automatically be saved to on `Add`
 * @param {function} handleAddVocab - callback function to handle adding vocab to default set
 */
const Vocab = ({ vocab, defaultSetId, handleAddVocab }) => {
    ...
    useEffect(() => {
        ...
        try {
            const savedStatus = await isSavedVocab(vocab, defaultSetId); // check if saved
